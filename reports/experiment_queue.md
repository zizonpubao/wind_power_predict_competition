...
| 29 | `submission_20260814_probe_s045_pair_g3w45.csv` | 위 셋 전부 결합 | 최대 기대값, 분산도 최대 |
| 30 | `submission_20260814_probe_strength0425_gbm35.csv` | 강도 0.425 세밀 스텝 | 곡선 정점 위치 확인 |

권장 순서: 27 → 26 → 28 → 29 → 30. **최종 제출선택**: 마감 직전, 리더보드 최고 점수 항목으로 교체
